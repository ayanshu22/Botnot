...
app.post('/webhook', async function (req, res) {
    ...
    for (var i in data.messages) {
        ...
        if(/help/.test(body)){
            const text = `${BOTCHAT}, this is a demo bot for https://eu137.chat-api.com/instance208430/
            Commands:
...
async function apiChatApi(method, params){
    ...
    const url = `${"https://eu137.chat-api.com/instance208430/"}/${"POST"}?token=${"cn8enib6l66t0a7e"}`; 
